          ...
          <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="model" value="<?php echo $data['models']['model'];?>" name="model">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="category" value="<?php echo $data['categories']['category'];?>" name="category">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="store" value="<?php echo $data['stores']['store'];?>" name="store">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" value="<?php echo $data['products']['availability'];?>" id="availability<?php echo $data['products']['availability'];?>" name="availability">
